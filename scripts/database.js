export const database = {
    ...
    hotdogLocations: [
        { id: 1, locationId: 1, hotdogId: 1, quantity: 23 },
        { id: 2, locationId: 1, hotdogId: 2, quantity: 34 },
        { id: 3, locationId: 1, hotdogId: 3, quantity: 45 },
        { id: 4, locationId: 1, hotdogId: 4, quantity: 56 },
        { id: 5, locationId: 1, hotdogId: 5, quantity: 45 },
        { id: 6, locationId: 1, hotdogId: 6, quantity: 43 },
        { id: 7, locationId: 1, hotdogId: 7, quantity: 42 },
        { id: 8, locationId: 1, hotdogId: 8, quantity: 31 },
        { id: 9, locationId: 1, hotdogId: 9, quantity: 51 },
        { id: 10, locationId: 2, hotdogId: 1, quantity: 45 },
        { id: 11, locationId: 2, hotdogId: 2, quantity: 36 },
        { id: 12, locationId: 2, hotdogId: 3, quantity: 25 },
        { id: 13, locationId: 2, hotdogId: 4, quantity: 35 },
        { id: 14, locationId: 2, hotdogId: 5, quantity: 42 },
        { id: 15, locationId: 2, hotdogId: 6, quantity: 70},
        { id: 16, locationId: 2, hotdogId: 10, quantity: 64 },
        { id: 17, locationId: 2, hotdogId: 11, quantity: 50 },
        { id: 18, locationId: 3, hotdogId: 1, quantity: 45 },
        { id: 19, locationId: 3, hotdogId: 2, quantity: 65 },
        { id: 20, locationId: 3, hotdogId: 3, quantity: 55 },
        { id: 21, locationId: 3, hotdogId: 4, quantity: 25 },
        { id: 22, locationId: 3, hotdogId: 5, quantity: 32 },
        { id: 23, locationId: 3, hotdogId: 6, quantity: 45 },
    ...
    drinkLocations: [  // drinkStock?
        ...
        { id: 6, locationId: 1, drinkId: 6, quantity: 99 },
        { id: 7, locationId: 1, drinkId: 7, quantity: 88 },
        { id: 8, locationId: 1, drinkId: 8, quantity: 65 },
        { id: 9, locationId: 2, drinkId: 1, quantity: 100 },
        { id: 10, locationId: 2, drinkId: 2, quantity: 110 },
        { id: 11, locationId: 2, drinkId: 3, quantity: 99 },
        { id: 12, locationId: 2, drinkId: 4, quantity: 101 },
        { id: 13, locationId: 2, drinkId: 5, quantity: 104 },
        { id: 14, locationId: 2, drinkId: 6, quantity: 105 },
        { id: 15, locationId: 2, drinkId: 7, quantity: 103 },
        { id: 16, locationId: 2, drinkId: 9, quantity: 55 },
        { id: 17, locationId: 3, drinkId: 1, quantity: 99 },
        { id: 18, locationId: 3, drinkId: 2, quantity: 97 },
        { id: 19, locationId: 3, drinkId: 3, quantity: 95},
        { id: 20, locationId: 3, drinkId: 4, quantity: 101 },
        { id: 21, locationId: 3, drinkId: 5, quantity: 103 },
        { id: 22, locationId: 3, drinkId: 6, quantity: 104 },
        { id: 23, locationId: 3, drinkId: 7, quantity: 105 },
        { id: 24, locationId: 3, drinkId: 10, quantity: 60 },
    ],
    dessertLocations: [
        {id: 1, locationId: 1, dessertId: 1, quantity: 45 },
        {id: 2, locationId: 1, dessertId: 2, quantity: 50 },
        {id: 3, locationId: 1, dessertId: 3, quantity: 55 },
        {id: 4, locationId: 1, dessertId: 4, quantity: 60 },
        {id: 5, locationId: 1, dessertId: 5, quantity: 65 },
        {id: 6, locationId: 1, dessertId: 6, quantity: 55 },
        {id: 7, locationId: 1, dessertId: 7, quantity: 45 },
        {id: 8, locationId: 2, dessertId: 1, quantity: 62 },
        {id: 9, locationId: 2, dessertId: 2, quantity: 64 },
        {id: 10, locationId: 2, dessertId: 3, quantity: 67 },
        {id: 11, locationId: 2, dessertId: 4, quantity: 75 },
        {id: 12, locationId: 2, dessertId: 5, quantity: 89 },
        {id: 13, locationId: 2, dessertId: 6, quantity: 50 },
        {id: 14, locationId: 2, dessertId: 8, quantity: 52 },
        {id: 15, locationId: 3, dessertId: 1, quantity: 56 },
        {id: 16, locationId: 3, dessertId: 2, quantity: 44 },
        {id: 17, locationId: 3, dessertId: 3, quantity: 42 },
        {id: 18, locationId: 3, dessertId: 4, quantity: 60 },
        {id: 19, locationId: 3, dessertId: 5, quantity: 61 },
        {id: 20, locationId: 3, dessertId: 6, quantity: 70 },
        {id: 21, locationId: 3, dessertId: 9, quantity: 73 }
    ],
    happyToysLocations: [
        { id: 1, locationId: 1, toyId: 1, quantity: 79 },
        { id: 2, locationId: 1, toyId: 2, quantity: 80},
        { id: 3, locationId: 1, toyId: 3, quantity: 89 },
        { id: 4, locationId: 2, toyId: 1, quantity: 69},
        { id: 5, locationId: 2, toyId: 2, quantity: 70 },
        { id: 6, locationId: 2, toyId: 3, quantity: 75},
        { id: 7, locationId: 2, toyId: 4, quantity: 85 },
        { id: 8, locationId: 3, toyId: 1, quantity: 65 },
        { id: 9, locationId: 3, toyId: 2, quantity: 56 },
        { id: 9, locationId: 3, toyId: 4, quantity: 62 }
    ],
    customOrders: []
}
